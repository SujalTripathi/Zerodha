...
function CreateTicket() {
    ...
    <div className="container">
        <div className="row p-5 mt-5 mb-5">
          ...
          <div className='col-4 p-5 mt-2 mb-4'>
            <h5 className='fs-5'>
          ...
          <div className='col-4 p-5 mt-2 mb-4'>
            <h4 className='fs-5'>
                <i class="fa fa-rocket" aria-hidden="true"></i> Kite
            </h4>
          ...
          <div className='col-4 p-5 mt-2 mb-4'>
            <h4 className='fs-5'>
                <i class="fa fa-wallet" aria-hidden="true"></i> Funds
            </h4>
          ...
          <div className='col-4 p-5 mt-2 mb-4'>
            <h4 className='fs-5'>
                <i class="fa fa-coins" aria-hidden="true"></i> Coin
            </h4>
